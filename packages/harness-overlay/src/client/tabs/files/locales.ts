export const filesTabsZh = {
  ...
  "files.layout.group": "文件视图布局",
  "files.layout.listLeft": "List-Left",
  "files.layout.listRight": "List-Right",
  "files.layout.treeLeft": "Tree-Left",
  "files.layout.treeRight": "Tree-Right",
  ...
  "files.preview.openFolder": "打开所在文件夹",
  "files.preview.loading": "正在加载预览",
  "files.preview.retry": "重试预览",
  "files.preview.resize": "调整文件预览宽度",
  "files.preview.editor": "编辑“{name}”",
  "files.preview.mode.group": "查看模式",
  "files.preview.mode.preview": "预览",
  "files.preview.more": "更多文件操作",
  "files.preview.actions": "文件操作",
  "files.preview.render.unavailable": "预览暂不可用，请切换到源码查看。",
...
> = {
  ...
  "files.layout.group": "File view layout",
  "files.layout.listLeft": "List-Left",
  "files.layout.listRight": "List-Right",
  "files.layout.treeLeft": "Tree-Left",
  "files.layout.treeRight": "Tree-Right",
  ...
  "files.preview.openFolder": "Open containing folder",
  ...
  "files.preview.mode.group": "View mode",
  "files.preview.mode.preview": "Preview",
  "files.preview.more": "More file actions",
  "files.preview.actions": "File actions",
  "files.preview.render.unavailable": "Preview is unavailable. Switch to Source to view this file.",
