...
Product subagents follow the Profile Bundle contract in the pinned `dsh-v0.1.5-alpha.2` runtime and are not embedded in Minke's base runtime. Install one into the `web` Profile:
